...
pub struct WatchdogEvent {
    ...
    /// Identificador curto do servidor (ex: "vps-runcloud-01", "erp-server")
    ...
    /// Nome do serviço que falhou (ex: "nginx-rc", "mysql", "nextjs-frontend")
    pub service: String,
    ...
    // ─── Remediação ───────────────────────────────────────────────────────────
    /// Ação executada (ex: "RestartService(nginx-rc)")
